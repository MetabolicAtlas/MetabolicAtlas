        ...
        <section id="home">
                            ...
                            <router-link :to="item.route">
                                <div class="card hoverable">
                                    ...
                                    <footer class="card-footer has-text-centered">
                                        <a
                                            class="card-footer-item has-text-weight-bold is-size-4 is-size-5-mobile"
                                        >
                                            {{ item.cardLink }}
                                        </a>
                                    </footer>
                ...
                <div class="container px-6">
                    ...
                    <div class="columns is-variable is-8 pt-3">
                        <div class="column is-6 is-size-5">
                            <p>
                                The main versions of <b>Metabolic Atlas</b> are associated with
                            ...
                            <div class="box">
                                <p>
                                    ...
                                    >
                                        Wang, H., et al, 2021.
                                        <i
                                            >Genome-scale metabolic network reconstruction of model
                                            animals as a platform for translational research</i
                            ...
                            <div class="box">
                                <p>
                                    ...
                                    >
                                        ...
                                        <i>An atlas of human metabolism</i>. Sci. Signal. 13,
                                        eaaz1482
                                    </a>
                                </p>
                            </div>
            ...
            <div class="py-6">
                <div class="container px-6 pt-6">
                    <!-- eslint-disable -->
                    <div
                        v-for="features in [features1, features2]"
                        class="columns is-variable is-8"
                    >
                        <div
                            v-for="item in features"
                            :key="item.title"
                            class="column is-6 is-size-5"
                        >
            ...
            <div class="py-6">
                <div class="container px-6">
                    <div class="columns is-variable is-8">
                        <div
                            v-for="item in comRes"
                            :key="item.title"
                            class="column is-6 is-size-5 py-6"
                        >
                            <p class="title is-size-4">
                                <router-link :to="item.route" class="has-text-primary">
                                    <span class="icon is-large fa-lg">
