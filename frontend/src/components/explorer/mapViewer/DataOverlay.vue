...
export default {
  ...
  computed: {
    ...
    isSelectedCustomtissue1() {
      return !this.disabledCustomSelectData && NOFILELOADED !== 'None' && NOFILELOADED !== this.customTissue1;
    },
    isSelectedCustomtissue2() {
      return !this.disabledCustomSelectData && NOFILELOADED !== 'None' && NOFILELOADED !== this.customTissue2;
    },
    isSelectedTissue1() {
