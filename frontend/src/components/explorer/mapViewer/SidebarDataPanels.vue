    ...
    <div id="sidebar_mapviewer">
        ...
        <template v-else-if="!selectionData.error">
            ...
            <div
                v-else-if="
                    selectionData.data &&
                    ['metabolite', 'gene', 'reaction'].includes(selectionData.type)
                "
                class="card my-3"
            >
                <header
                    ...
                    <a href="#" class="card-header-icon" aria-label="more options">
                        <span class="icon">
                            <i
                                aria-hidden="true"
                                :class="[
                                    showSelectionCardContent ? 'fa-caret-down' : 'fa-caret-right',
                                    'fa',
                                ]"
                            ></i>
                        </span>
                    ...
                    <div class="content">
                        ...
                        >
                            ...
                            <template v-if="item.name === 'synonyms'">
                                ...
                                <p>
                                    <template
                                        v-for="s in selectionData.data[item.name].split('; ')"
                                    >
                                        &ndash;&nbsp;{{ s }}<br :key="s" />
                                    </template>
                                </p>
            ...
            <div class="card my-3">
                <header class="card-header is-clickable">
                    <p class="card-header-title is-inline is-unselectable has-text-weight-normal">
                        ...
                        Email us at
                        <a href="mailto:contact@metabolicatlas.org"
