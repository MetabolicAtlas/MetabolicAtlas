<template>
  <div class="canvasOption overlay p-2">
    ...
    >
      <i :class="[showGenes ? 'far fa-eye-slash' : 'far fa-eye']">&thinsp;G</i>
    </span>
    <span
      v-if="toggleLabels"
      class="button p-2"
    ...
    >
      <i :class="[showLabels ? 'far fa-eye-slash' : 'far fa-eye']">&thinsp;L</i>
    </span>
    <span
    ...
    >
      <i :class="[showSubsystems ? 'far fa-eye-slash' : 'far fa-eye']">&thinsp;S</i>
    </span>
    <span
    ...
    >
      <i :class="{ 'fa fa-compress': isFullscreen, 'fas fa-expand-arrows-alt': !isFullscreen }"></i>
    </span>
