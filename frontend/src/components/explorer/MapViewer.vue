        ...
        <div id="mapViewerContainer" class="columns ordered-mobile m-0">
            <template v-if="errorMessage">
                <div class="column is-danger is-half is-offset-one-quarter">
                    <div
                        class="notification is-danger is-danger has-text-centered"
                        v-html="errorMessage"
                    />
                </div>
            </template>
            <template v-else>
                    ...
                    <div id="mapSidebar__header" class="has-background-lightgray pt-3">
                        ...
                        >
                            <button
                                ...
                                :class="
                                    dim === showing2D
                                        ? 'is-selected is-primary has-text-weight-bold'
                                        : 'is-light'
                                "
                ...
                >
                    <NotFound
                        v-if="mapNotFound"
                        type="map"
                        :component-id="$route.params.map_id"
                    ></NotFound>
                ...
                >
                    ...
                    <ErrorPanel
                        ...
                        @hideErrorPanel="loadMapErrorMessage = ''"
                    />
                </div>
                <div
                    id="dataOverlayBar"
...
export default {
    ...
    methods: {
        ...
        handleQueryParamsWatch(newQuery, oldQuery) {
            ...
            if (
                newQuery.dim === this.$route.query.dim ||
                (newQuery.dim && !this.$route.query.dim)
            ) {
                history.replaceState(...payload) // eslint-disable-line no-restricted-globals
            } else {
