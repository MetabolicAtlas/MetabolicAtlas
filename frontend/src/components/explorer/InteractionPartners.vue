                ...
                <div v-if="!mainNodeID">
                    <div class="has-text-centered">
                        ...
                        >
                            ...
                            <span v-if="model"
                                >random components of {{ model.short_name || 'a model' }}</span
                            >
                        </a>
                        <br />
                    </div>
                    ...
                    >
                        ...
                        <div>
                            <template v-if="clickedElm && clickedElm['reaction']">
                                <template
                                    v-for="(r, index) in Array.from(clickedElm.reaction).slice(
                                        0,
                                        16
                                    )"
                                >
                                    ...
                                    <span v-else class="has-margin-left">
                                        {{
                                            `${
                                                Array.from(clickedElm.reaction).length - 15
                                            } others reaction(s)...`
                                        }}
                                    </span>
                                </template>
                        ...
                        <template v-if="largeNetworkGraph">
                            <div class="column is-8-desktop is-fullwidth-tablet">
                                <div class="notification is-warning has-text-centered">
                                    ...
                                    <span class="button" @click="generateGraph(fitGraph)"
                                        >Generate</span
                                    >
                                </div>
                            </div>
                        ...
                        <template v-else-if="showNetworkGraph">
                            <div class="column is-8-desktop is-fullwidth-tablet">
                                <div id="graphOption">
                                    ...
                                    <span
                                        class="button"
                                        title="Clean selection/highlight"
                                        @click="resetGraph(false)"
                                    >
                                        <i class="fa fa-eraser"></i>
                                    </span>
                                </div>
                                <div
                                    v-show="showGraphLegend"
                                    id="contextGraphLegend"
                                    ref="contextGraphLegend"
                                >
                                    ...
                                    <div class="comp">
                                        ...
                                        <div class="select">
                                            <select
                                                v-model="nodeDisplayParams.geneNodeShape"
                                                @change="redrawGraph()"
                                            >
                                                <option
                                                    v-for="shape in availableNodeShape"
                                                    :key="shape"
                                                >
                                                    {{ shape }}
                                                </option>
                                    ...
                                    <div class="comp">
                                        ...
                                        <span
                                            ...
                                            :style="{
                                                background:
                                                    nodeDisplayParams.metaboliteNodeColor.hex,
                                            }"
                                    ...
                                    <div class="card-content py-2 p-3">
                                        ...
                                        <div v-show="subsystemList.length !== 0">
                                            ...
                                            <div class="select is-fullwidth">
                                                <select
                                                    v-model="subsystemHL"
                                                    @change.prevent="highlightSubsystem"
                                                >
            ...
            if (isValid) {
                ...
                for (let i = 0; i < componentIds.length; i += 1) {
                    ...
                    for (let j = 0; j < dataSets.length; j += 1) {
                        ...
                        this.rawElms[componentID].expressionLvl[s][t][d] =
