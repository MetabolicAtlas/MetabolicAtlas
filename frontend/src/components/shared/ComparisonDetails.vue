        ...
        <div class="card-content">
            <div v-if="comparisonDetails" class="content">
                <p>
                    The
                    <router-link
                        :to="{ name: 'explorer', params: { model: currentModel.short_name } }"
                    >
                ...
                <div v-if="selectedCell.position.row !== selectedCell.position.col">
                    Compared to
                    <span
                        v-for="(cm, i) in comparedModels"
                        :key="cm.short_name"
                        class="compared-models"
                    >
                    ...
                    <ul>
                        ...
                        <li v-for="t in Object.keys(types)" :key="t">
                            ...
                            <div class="tags">
                                <span
                                    v-for="id in comparisonDetails.details[types[t]].unique.slice(
                                        0,
                                        20
                                    )"
                                    :key="id"
    ...
    computed: {
        ...
        currentModel() {
            ...
            return this.modelList.find(
                (m) => m.apiName === this.comparisonDetails.models.model.model
            )
        },
        comparedModels() {
