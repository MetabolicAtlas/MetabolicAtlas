          ...
          <div class="columns ml-0">
            <div class="column pl-0 is-8 content">
              ...
              <p>
                ...
                value >=0.9 means that there is high confidence that the reaction is present,
                whereas a low value <=0.1 means it is not. The resulting values were then scaled to
                0-1 as per
                <a
