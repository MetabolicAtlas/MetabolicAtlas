      ...
      <div class="columns is-variable is-8">
        ...
        <div id="documentation" class="column content has-text-justified">
          <p>
            ...
            <a href="#Integrated-models">Genome-scale metabolic models (GEMs)</a> by using the
            <a href="#GEM-Browser">GEM Browser</a> tool, and enables navigation of the metabolic
            network maps via the <a href="#Map-Viewer">Map viewer</a> tool. Moreover, interactions
            betweeen metabolites and genes can be explored with the
            <a href="#Interaction-Partners">Interaction Partners</a> tool. These three tools are
            available upon selecting one of the integrated models. The selected model is indicated
            to the right of the Metabolic Atlas logo in the top navigation bar. Leaving the
            <i>Explore</i> section (or the <i>GEM Browser</i> / <i>Map Viewer</i> tools) will
            unselect the model, and remove its name from the navigation bar.
          </p>
          <p>
          ...
          <p>
            The <i>GEM Browser</i> is a set of dedicated pages for various components, i.e.,
            reactions, metabolites, genes, subsystems and compartments of the selected model, which
            is indicated on the left side of the top navigation bar. Each page contains a button on
            the right to <i>Report an issue</i>. Click this button to report a problem or ask
            questions to the modellers.
          </p>

          <h5 id="reaction-page" class="is-size-5">Reaction page</h5>
          <p>
            The <i>Reaction</i> page shows the information about the currently selected reaction. If
            provided by the modellers, a list of cross references to other models or databases and a
            list of references (PMIDs) are also shown in the <i>Cross references</i> and
            <i>References</i> tables respectively. On the right side of the page there is a list of
            links pointing to 2D or 3D <a href="#Map-Viewer">Map Viewer</a> pages in which this
            reaction is involved.
          </p>

          <h5 id="metabolite-page" class="is-size-5">Metabolite page</h5>
          <p>
            The <i>Metabolite</i> page shows information of the currently selected metabolite.
            Metabolites in GEMs are often differentiated according to their cell compartment
            localization. For this reason, one metabolite, e.g. cholesterol, may correspond to
            several different metabolite entries in a GEM, such as cholesterol[c], cholesterol[m],
            with the suffix indicating the compartment in which the metabolite is localized.
          </p>
          <p>
            ...
            shown in the <i>Cross references</i> table under the top table.
          </p>
          <p>
            Below the <i>Cross references</i> table comes the <i>Reactions</i> table. It lists all
            reactions involving the current metabolite as a reactant or product. The current
            metabolite is highlighted in black in the reaction equations. This table can be exported
            by clicking the button <i>Export to TSV</i>. Since metabolites are specific to a cell
            compartment, only reactions involving the metabolite in its specific compartment are
            displayed. To remove this restriction and display additional reactions involving the
            metabolite in any compartment, click the button to
            <i>See reactions from all compartments</i>. Note that the number of retrieved reactions
            is limited to 200. It is recommended to use the <a href="#API">API</a> to retrieve all
            reactions.
          </p>
          <p>
            On the top right of the page, the
            <a href="#Interaction-Partners">Interaction Partners</a> tool for that metabolite can be
            accessed by clicking the button <i>Interaction Partners</i>. Below this button there is
            a widget to access the corresponding 2D or 3D <a href="#Map-Viewer">Map Viewer</a> pages
            for this metabolite.
          </p>
          ...
          <p>
            ...
            <a href="#GEM-Browser-Metabolite">Metabolite</a> page except that the top table shows
            the information about the currently selected gene.
          </p>
          ...
          <p>
            ...
            <a href="#GEM-Browser-Metabolite">Metabolite</a> page except that the top table shows
            information on the current selected metabolic subsystem instead of metabolites. In
            addition, the maximum number of reactions shown in the <i>Reactions</i> tables is
            limited to 1000 instead of 200.
          </p>
          <p>
          ...
          <p>
            ...
            <a href="#API">API</a> to retrieve a complete set of metabolites and genes for the
            selected subsystem. Note that, in some GEMs, a given reaction can be associated with
            multiple subsystems.
          </p>

          <h5 id="compartment-page" class="is-size-5">Compartment page</h5>
          <p>
            The <i>Compartment</i> page shows the information of the currently selected compartment.
            It is only the number of metabolites, genes and reactions is shown in the top table. To
            retrieve a full list of metabolites, genes and reactions for a comparment, the use of
            the <a href="#API">API</a> is advised. Similarly to the
            <a href="#GEM-Browser-Metabolite">Metabolite</a> page the list of links to the 2D or 3D
            Map Viewer pages where this compartment can be visualized is displayed on the right side
            of the page.
          </p>
          ...
          <p>
            The <i>Map Viewer</i> is, similar to the <a href="#GEM-Browser">GEM Browser</a>,
            ...
            in 3 dimensions. One can easly go back and forth between the <i>GEM Browser</i> and
            <i>Map Viewer</i> by clicking the button <i>GEM Browser</i> in the left sidebar of the
            <i>Map Viewer</i> page and links of the <i>Map Viewer</i> panel on the right side of the
            <i>GEM Browser</i> page, respectively.
          </p>
          <p>
            To switch between 2D maps and 3D networks, use the <i>Switch to 2D</i> or
            <i>Switch to 3D</i> button in the top left of the map, respectively. This button is
            disabled for a model without 2D maps, or when the corresponding 2D version of a 3D
            network is not available. One can select which compartment or subsystem to be shown in
            the viewer by clicking a corresponding item on the left sidebar.
          </p>
          ...
          <p>
            ...
            fullscreen mode with the key <i>Esc</i>), and download the SVG map on the current view.
            One can interact with the map by clicking and dragging the mouse to pan the view or
          ...
          <p>
            ...
            <i>Highlight</i> button to color all found components on the maps in red. To remove the
            highlight, simply clear the search bar.
          </p>
          <p>
          ...
          <p>
            ...
            <i>GEM Browser</i> under the information panel of the selected element on the left
            sidebar.
          </p>
          <p>
          ...
          <div class="columns ml-0">
            <div class="column pl-0 is-8 content">
              <p>
                The <i>Data overlay</i> panel is by default hidden in the <i>Map Viewer</i>. By
                clicking the <i>Data overlay</i> button on the right side of the page, one can
                toggle the hidden/display of this panel. On the <i>Data overlay</i> panel, gene
                expression levels for genes from
                ...
                shown
                <b>Figure 1</b>). To clear the RNA levels, select the <i>None</i> option in the drop
                down list. RNA levels are available for both 2D and 3D Map Viewer. The data is
                obtained from version 18 of the Protein Atlas with the units in
                log<sub>2</sub>(TPM+1) associated with a gradient colorbar.
              </p>
              <p>
                The <i>Data overlay</i> sidebar allows uploading of the custom data in
                ...
                serie, as shown in the example to the right (<b>Figure 2</b>). The headers of these
                data series will be shown automatically in the dropdown options for the uploaded
          ...
          <div id="interaction-partners-intro">
            ...
            <div>
              <p>
                ...
                there is a prompt before generating the graph. For very large networks (e.g. for
                H<sub>2</sub>O) the graph will not be generated. One can left-click a node to
                display a context menu with 3 options:
              </p>
              <ul>
                <li>
                ...
                <li>
                  ...
                  <span><i class="fa fa-eraser"></i></span> eraser button at the top of the graph.
                </li>
              </ul>
            </div>
          </div>
          ...
          <p>
            ...
            sidebar to quickly reset the <i>Interaction Partners</i> for that node or navigate to
            the corresponding <a href="#GEM-Browser">GEM Browser</a> page.
          </p>
          <p>
          ...
          <p>
            ...
            <a href="https://www.proteinatlas.org/">Human Protein Atlas</a> can be enabled and
            applied on the <i>Interaction Partners</i> graph with the panel on the top right, by
            selecting one of the tissues in the drop down list. The action will update the color of
            gene's nodes according to the legend. Some genes may not have RNA levels available in
            Human Protein Atlas, and in such case their color corresponds to the n/a color.
          </p>
          ...
          <p>
            Information of the reactions are listed in <i>Reactions</i> table which is located on
            the lower part of the page. Selecting a label of metabolite or gene in the table will
            select the corresponding node on the graph, and vice versa. Selecting a reaction ID
            label highlight the reaction on the graph. The search bar above the table can be used to
            filter out rows to find a given component. This table can be exported by clicking the
            button <i>Export to TSV</i>.
          </p>
          ...
          <p>
            ...
            <i>Quick search</i> and <i>Global search</i>. One can search for any terms in
            metabolites, genes, reactions, subsystems or compartments information with both
            searching methods. In addition, proximity searching is enabled so that the searching
            algorithm will not only search for exact matching of the input keywords but also try to
            find hits that are similar to the input keywords.
          </p>

          <h5 id="Quick-search" class="is-size-5">Quick search</h5>
          <p>
            By clicking the icon <span><i class="fa fa-search"></i></span> in the top navigation
            bar, one can perform a quick search of any terms in metabolites, genes, reactions,
            subsystems or compartments. The found hits will be shown directly under the searching
            bar if there is any or prompted with <i>No matches</i>. The results links redirect to
            the corresponding <i>GEM Browser</i> page of the component clicked. One can also click
            the icon <span><i class="fa fa-table"></i></span> or
            <span><i class="fa fa-connectdevelop"></i></span> to the left of each found hit to
            redirect to the <i>Metabolite</i> page or <i>Interaction Parters</i> page respectively.
          </p>
          <p>
            The <i>Quick search</i> is restricted to the selected GEM on the left side of searching
            bar and limited to 50 results per component type. Alternatively, one can click on the
            banner under the search input field to run a <i>Global Search</i>, where the term is
            searched among all the integrated models' components and is unrestricted. To learn more
            about the search term possiblities, go to the
            <a href="#Global-Search">Global Search</a> section of this page.
          </p>

          <h5 id="Global-search" class="is-size-5">Global search</h5>
          <p>
            The <i>Global search</i> page queries all the integrated metabolic models. Each
            metabolic component has its own results table accessible via the dedicated tab. Tabs are
            inactivated when no results are found. The search text is not restricted to the visible
            columns; for example, searching an MetaNetX ID will return results for the metabolites
            and/or reactions matching the ID even though the MetaNetX column is not in the table.
            The search algorithm matches partial names of components: searching for 'cholesterol'
          ...
          <p>
            ...
            <i>Worm-GEM</i>, <i>Yeast-GEM</i> and <i>Zebrafish-GEM</i>. Details can be found at the
            <router-link :to="{ name: 'gems', hash: '#Integrated-models' }"
              >GEM Repository</router-link
            >
            page.
          ...
          <p>
            In the second section, the <i>Comparison</i> page provides statistics about the
            comparison/overlap between Human-GEM 1.0.2 and HMR 2.0, as well as Human-GEM and
            Recon3D. This comparison has been performed manually for an early verion of Human-GEM,
          ...
          <p>
            ...
            <a :href="`ftp://${ftpUrl}/`">ftp://{{ ftpUrl }}</a> or by connecting to the FTP using
            your favorite FTP client (e.g. <a href="https://filezilla-project.org/">FileZilla</a>).
          </p>
          ...
          <p>
            ...
            <a href="/api/v2/" target="_blank">dedicated interface to facilite the use of the API</a
