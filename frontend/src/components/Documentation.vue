        ...
        <div id="documentation" class="column content has-text-justified">
          ...
          <div class="columns ml-0">
            <div class="column pl-0 is-8 content">
              ...
              <p>
              The reaction presence was initially computed as a number between 0 and 100. The value
              is computed by creating bootstraps from the single-cell RNA-Seq data from the <a
              href="https://www.proteinatlas.org/about/releases#21.0" target="_blank">Human Protein
              Atlas - Single Cell Type Section</a>, pooling those into RNA-Seq profiles and applying
              the ftINIT algorithm. A high value >=0.9 means that there is high confidence that the
              reaction is present, whereas a low value <=0.1 means it is not. The resulting values
              were then scaled to 0-1 as per <a
              href="https://github.com/MetabolicAtlas/data-files/blob/main/DATA_OVERLAY.md"
              target="_blank">these guidelines</a>. For more information on single-cell bootstraps
              and how ftINIT works, please see <a
              href="https://www.biorxiv.org/content/10.1101/2022.04.25.489379v1.full"
              target="_blank">this manuscript</a>.
              </p>
              <p>
                The
                <i>Data overlay</i>
