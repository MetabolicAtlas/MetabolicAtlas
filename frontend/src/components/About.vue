        ...
        <div class="container is-fullhd">
            ...
            <div class="columns is-variable is-8">
                <div class="column is-half has-text-justified">
                    <div class="box is-hidden-tablet">
                        <p
                            class="subtitle has-text-weight-bold is-size-4 has-text-primary has-text-centered"
                        >
                            Citing Metabolic Atlas
                        </p>
                        <p>
                            <a href="https://doi.org/10.1073/pnas.2102344118" target="_blank">
                                Wang, H., et al, 2021.
                                <i
                                    >Genome-scale metabolic network reconstruction of model animals
                                    as a platform for translational research</i
                                >. PNAS 118, e2102344118
                            </a>
                        </p>
                        <p>
                            <a href="https://doi.org/10.1126/scisignal.aaz1482" target="_blank">
                                Robinson, J., et al, 2020. <i>An atlas of human metabolism</i>. Sci.
                                Signal. 13, eaaz1482
                            </a>
                        </p>
                    </div>
                    The Metabolic Atlas project is headed by
                    <a href="https://www.sysbio.se/labs/nielsen" target="_new"
                    ...
                    <a href="https://www.chalmers.se" target="_new"
                    ...
                    <a
                        ...
                        >Computational Systems Biology Infrastructure</a
                    >
                    at Chalmers University of Technology and
                    <a href="https://nbis.se" target="blank"
                    ...
                    about a set of open-source Genome-Scale Metabolic Models (GEMs), specifically
                    <router-link :to="{ name: 'explorer', params: { model: 'Human-GEM' } }"
                        >Human-GEM</router-link
                    >
                    and
                    <router-link :to="{ name: 'explorer', params: { model: 'Yeast-GEM' } }"
                        >Yeast-GEM</router-link
                    >. These are two reference models containing all possible reactions that could
                    occur in human, and yeast, respectively.<br /><br />

                    The research focus of the content of this website is
                    <b>metabolism in a systems biology context</b>. The goal is to collect many
                    curated GEMs, and to bring these models closer to
                    <a href="https://en.wikipedia.org/wiki/FAIR_data" target="_new"
                        >FAIR principles</a
                    >. To this end, the website also provides visualisations and comparisons of the
                    GEMs, and links to <a href="resources">resources</a>: algorithms, other
                    databases, and more general software applications (like RAVEN and PIANO).<br /><br />

                    Metabolic Atlas is intended to be used for applications in metabolomics,
                    clinical chemistry, biomarker discovery and general education. In short, the
                    vision is to create a one-stop-shop for everything metabolism related, starting
                    with
                    <a href="https://www.sysbio.se/labs/nielsen/#publications"
                        >the publications of the Nielsen lab</a
                    >.<br /><br />

                    The development of Metabolic Atlas is led by
                    <a href="https://nbis.se/about/staff/mihail-anton" target="_blank"
                        >Mihail Anton</a
                    >, with team members Pierre-Etienne Cholley and Shan Huang. Past and more
                    detailed contributions are
                    <a
                        href="https://github.com/SysBioChalmers/MetabolicAtlas/graphs/contributors"
                        target="_blank"
                        >shown on GitHub</a
                    >. For versions and release notes of the software behind Metabolic Atlas,
                    <a
                        href="https://github.com/SysBioChalmers/MetabolicAtlas/releases"
                        target="_blank"
                        >check the GitHub page</a
                    >
                    or
                    <a href="https://zenodo.org/badge/latestdoi/53664497" target="_blank">Zenodo</a
                    >. The integrated models are also available on GitHub, check our
                    <router-link :to="{ name: 'gems' }">GEM Repository</router-link> for links to
                    those.<br /><br />

                    <p>
                        Metabolic Atlas would not be possible without the following excellent Elixir
                        resources:
                        <a href="https://proteinatlas.org" target="_blank"
                        ...
                        <a href="https://identifiers.org" target="_blank">Identifiers.org</a>,
                        <a href="https://www.ebi.ac.uk/chebi" target="_blank">ChEBi</a> and other
                        essential sources of information:
                        <a href="http://www.genome.jp/kegg/" target="_blank"
                            >KEGG: Kyoto Encyclopedia of Genes and Genomes</a
                        >,
                        <a href="http://www.hmdb.ca/" target="_blank"
                            >The Human Metabolome Database</a
                        >, <a href="https://www.metanetx.org" target="_blank">MetaNetX</a>,
                ...
                >
                    <div class="card card-fullheight">
                        <div class="card-content">
                            ...
                            <div class="content" v-html="advisor.content"></div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="timeline is-centered">
                ...
                <template v-for="year in Object.keys(news).reverse()">
                    ...
                    <!-- eslint-disable-next-line vue/valid-v-for vue/require-v-for-key -->
                    <header class="timeline-header">
                        <span class="tag is-large has-text-primary has-text-weight-bold">{{
                            year
                        }}</span>
                    </header>
                </template>
            ...
            <div class="columns is-variable is-8">
                <div class="column has-text-justified content">
                    ...
                    <p>
                        Metabolic Atlas gathers information about users solely to improve the
                        usability and usefulness of the website. There are two types of cookies that
                        are set by Metabolic Atlas: functionality cookies and tracking cookies.<br />
                        Functionality cookies are used to personalize the appearence of the
                        Metabolic Atlas.<br />
                        Tracking cookies are used by our private analytics to track the users on our
                        website. We use these to observe the anonymized behaviour on our website in
                        order to improve it. We store partial IP, operating system, browser and
                        browser language. This information is stored permanently for statistics and
                        is not shared with any third party.<br />
                        Additionally, we use the services of
                        <a href="https://www.hotjar.com/" target="_blank">Hotjar</a>. This is an
                        additional independent tracking service, which can produce a screen capture
                        of the interactions on our website, including mouse movement. We use it for
                        the purpose of figuring out how to improve our website, for example when the
                        website interface is confusing. The data is stored for at most 3 months.
                        Hotjar adheres to GDPR,
                        <a
                            href="https://www.hotjar.com/legal/compliance/gdpr-commitment"
                            target="_blank"
                            >see more on their website</a
                        >.<br />
                        To opt out of any of these cookies, please set your browser to use the
                        "DoNotTrack" header; doing this will disable the tracking. It is a good
                        practice to enable this setting, here is how to do this for
                        <a href="https://support.google.com/chrome/answer/2790761" target="_blank"
                            >Chrome</a
                        >
                        and
                        <a
                    ...
                    <p>
                        We do not guarantee the accuracy of any provided data, generated database,
                        software or online service nor the suitability of databases, software and
                        online services for any purpose. The content presented on Metabolic Atlas is
                        contributed by members of the community who remain owners of said content.
                    </p>
                </div>
            </div>
        </div>
