    ...
    return {
      news: {
        2020: [
          ...
          { date: '23 March 2020',
            text: '<b>Metabolic Atlas 1.6</b> is out. This release contains many user interface improvements, documentation updates and correction of typos. More details can be found <a href="https://github.com/SysBioChalmers/MetabolicAtlas/releases/tag/1.6" target="_blank">on GitHub</a>.' },
