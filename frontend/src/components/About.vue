    ...
    <div class="container is-fullhd">
      ...
      <div class="columns is-variable is-8">
        <div class="column is-half has-text-justified">
          ...
          <a href="https://nbis.se/about/staff/mihail-anton" target="_blank">Mihail Anton</a>
          , with team members Pierre-Etienne Cholley and Shan Huang. Past and more detailed
          contributions are
          <a
          ...
          <router-link :to="{ name: 'gems' }">GEM Repository</router-link>
          for links to those.
          <br />
          <br />
      ...
      <div class="columns is-variable is-8">
        <div class="column has-text-justified content">
          ...
          <p>
            ...
            Atlas: functionality cookies and tracking cookies.
            <br />
            ...
            stored permanently for statistics and is not shared with any third party.
            <br />
            Additionally, we use the services of
            <a href="https://www.hotjar.com/" target="_blank">Hotjar</a>
            . This is an additional independent tracking service, which can produce a screen capture
            of the interactions on our website, including mouse movement. We use it for the purpose
