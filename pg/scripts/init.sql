...
-- create search indexes along with materialized views
...
union all
select text 'enzymes_proteins' as origin_table, protein as id, protein as search_field from enzymes_proteins
union all
